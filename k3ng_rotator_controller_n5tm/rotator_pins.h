...
#define button_cw 8              // normally open button to ground for manual CW rotation (schematic pin: A2)
#define button_ccw 9             // normally open button to ground for manual CCW rotation (schematic pin: A3)
...
/*----------- elevation pins --------------*/
  ...
  #define button_up 10               // normally open button to ground for manual up elevation
  #define button_down 11             // normally open button to ground for manual down rotation
